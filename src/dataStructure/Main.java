...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //List<String> stringList = Arrays.asList("qqqqq".split(""));
        System.out.println("123457|sdsdsds".contains("\\|"));

        //Map<String,Boolean> dataStructure.map = stringList.stream().collect(Collectors.toMap(String::toString,Boolean::getBoolean));
        //System.out.println(dataStructure.map);
    }
